...
API_ID = int(environ['26992030'])
API_HASH = environ['4da7d71c6bc4512a886e41aca83a5ee3']
BOT_TOKEN = environ['8026778102:AAEsTeZXg7kAstTC2jtmqSchmLRcZD-Vyds']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6476706511').split()]
